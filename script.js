...
function getBotResponse(userMessage) {
    ...
    if (lowerInput.includes("oi") || lowerInput.includes("olá")) {
        ...
        return "Estratégias validadas e plataforma com falhas no link abaixo ✓✓✓✓✓✓✓✓   https://linktr.ee/Rei_do_nicho_black ✓✓✓✓✓✓✓✓ -----> (COPIE ESSE LINK E COLE NO SEU NAVEGADOR OU CHROME!)";
    } else {
